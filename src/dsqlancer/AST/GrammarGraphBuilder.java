...
public class GrammarGraphBuilder {
    public static String find_condition(ParserRuleContext node, Options options){
    ...
    public static HashMap<String, String> arg_action_block(ParserRuleContext node){
        ...
        //So the parent class (ParserRuleContext) does not have argActionBlock method
        //But the child classes do
        //Normally an inheritance would be used
        //But I'm rather reluctant to change the ANTLRv4Parser generated by ANTLR
        //Who knows what mess will be caused orz
