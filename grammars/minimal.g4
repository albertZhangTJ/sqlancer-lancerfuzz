...
insertStatement
    : INSERT INTO? {ERR("Duplicate");} tableName[def=t]  (
       '(' columnName[ref=t, def=c, uni=id1] ( ',' columnName[ref=t, def=c, uni=id1] { RP_LIMIT(0, 5); RP_ID("a"); })* ')' 
...
pre locals [is_dependent] : ('(' columnName[ref=t, def=cc, uni=id1] comparison expr ')' {BRANCH_W(3);}
